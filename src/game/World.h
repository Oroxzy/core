...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_MAPUPDATE_INSTANCED_SUBTICK,
    ...
    CONFIG_UINT32_AUTO_EQUIP_MIN_LEVEL,
    CONFIG_UINT32_AUTO_EQUIP_MAX_QUALITY,
    CONFIG_UINT32_AUTO_EQUIP_MAX_ITEM_LEVEL_BONUS,
    CONFIG_UINT32_AUTO_EQUIP_CANDIDATE_ITEM_LEVEL_WINDOW,
    CONFIG_UINT32_AUTO_EQUIP_DELETE_REPLACED_MAX_QUALITY,
    CONFIG_UINT32_AUTO_PROGRESSION_TALENT_DEBOUNCE_MS,
    CONFIG_UINT32_AUTO_PROGRESSION_AUDIT_STEP_INTERVAL_MS,
    CONFIG_UINT32_ARENA_MAX_ITEM_LEVEL,
    CONFIG_UINT32_ARENA_MAX_ITEM_PATCH,
    CONFIG_UINT32_ARENA_TIME_LIMIT_MINUTES,
    CONFIG_UINT32_ARENA_READY_START_DELAY_SECONDS,
    CONFIG_UINT32_ARENA_INVITE_ACCEPT_TIME_SECONDS,
    CONFIG_UINT32_ARENA_MIN_LEVEL,
    CONFIG_UINT32_ARENA_SPECTATOR_SMOOTH_DELAY,
    CONFIG_UINT32_ARENA_SPECTATOR_CARRY_ON,
    CONFIG_UINT32_ARENA_LEAVE_LOCKOUT_MINUTES,
    CONFIG_UINT32_ARENA_MAX_RES_FIRE,
    CONFIG_UINT32_ARENA_MAX_RES_NATURE,
    CONFIG_UINT32_ARENA_MAX_RES_FROST,
    CONFIG_UINT32_ARENA_MAX_RES_SHADOW,
    CONFIG_UINT32_ARENA_MAX_RES_ARCANE,
    CONFIG_UINT32_ARENA_RATED_MODE,
    CONFIG_UINT32_ARENA_RATED_START_RATING,
    CONFIG_UINT32_ARENA_RATED_START_MMR,
    CONFIG_UINT32_ARENA_RATED_WIN_MODIFIER_LOW,
    CONFIG_UINT32_ARENA_RATED_WIN_MODIFIER,
    CONFIG_UINT32_ARENA_RATED_LOSE_MODIFIER,
    CONFIG_UINT32_ARENA_RATED_MMR_MODIFIER,
    CONFIG_UINT32_ARENA_RATED_DRAW_LOSS,
    CONFIG_UINT32_ARENA_RATED_MAX_MMR_DIFFERENCE,
    CONFIG_UINT32_ARENA_RATED_MMR_DISCARD_MINUTES,
    CONFIG_UINT32_ARENA_RATED_LADDER_MIN_GAMES,
    CONFIG_UINT32_ARENA_RATED_MIN_LEVEL,
    CONFIG_UINT32_ARENA_NAGRAND_TORNADO_DAMAGE_PCT,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_AUTO_EQUIP_PRIMARY_STAT_SCALE,
    CONFIG_FLOAT_AUTO_EQUIP_SECONDARY_STAT_SCALE,
    CONFIG_FLOAT_AUTO_EQUIP_SURVIVAL_STAT_SCALE,
    CONFIG_FLOAT_AUTO_EQUIP_WEAPON_DPS_SCALE,
    CONFIG_FLOAT_AUTO_EQUIP_SPELL_POWER_SCALE,
    CONFIG_FLOAT_AUTO_EQUIP_MIN_UPGRADE_PERCENT,
    CONFIG_FLOAT_AUTO_EQUIP_ARMOR_CLASS_BONUS_PERCENT,
    CONFIG_FLOAT_AUTO_EQUIP_SET_BONUS_SCALE,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_AUTO_LEARN_ON_LEVEL_UP,
    CONFIG_BOOL_AUTO_LEARN_ON_TALENT_LEARN,
    CONFIG_BOOL_AUTO_LEARN_ON_LOGIN,
    CONFIG_BOOL_AUTO_LEARN_CLASS_TRAINERS,
    CONFIG_BOOL_AUTO_LEARN_WEAPON_TRAINERS,
    CONFIG_BOOL_AUTO_LEARN_MAX_WEAPON_SKILLS,
    CONFIG_BOOL_AUTO_LEARN_CLASS_QUEST_SPELLS,
    CONFIG_BOOL_AUTO_LEARN_CLASS_QUEST_ITEMS,
    CONFIG_BOOL_AUTO_LEARN_SPELL_BOOKS,
    CONFIG_BOOL_AUTO_TALENT_ON_LEVEL_UP,
    CONFIG_BOOL_AUTO_TALENT_ON_LOGIN,
    CONFIG_BOOL_AUTO_PROGRESSION_APPLY_TO_BOTS,
    CONFIG_BOOL_AUTO_EQUIP_ON_LEVEL_UP,
    CONFIG_BOOL_AUTO_EQUIP_ON_TALENT_LEARN,
    CONFIG_BOOL_AUTO_EQUIP_ON_LOGIN,
    CONFIG_BOOL_AUTO_EQUIP_ON_TALENT_RESET,
    CONFIG_BOOL_AUTO_EQUIP_REQUIRE_DISCOVERED,
    CONFIG_BOOL_AUTO_EQUIP_IGNORE_ITEMS_WITHOUT_STATS_AND_ARMOR,
    CONFIG_BOOL_AUTO_EQUIP_REPLACE_EXISTING,
    CONFIG_BOOL_AUTO_EQUIP_DELETE_REPLACED_ITEMS,
    CONFIG_BOOL_AUTO_EQUIP_INCLUDE_QUEST_REWARDS,
    CONFIG_BOOL_AUTO_EQUIP_ALLOW_BOE_QUEST_REWARDS_WITHOUT_QUEST,
    CONFIG_BOOL_AUTO_EQUIP_SOURCE_VENDOR,
    CONFIG_BOOL_AUTO_EQUIP_SOURCE_CRAFTED,
    CONFIG_BOOL_AUTO_EQUIP_SOURCE_WORLD_LOOT,
    CONFIG_BOOL_AUTO_EQUIP_SOURCE_DUNGEON_LOOT,
    CONFIG_BOOL_AUTO_EQUIP_SOURCE_RAID_LOOT,
    CONFIG_BOOL_AUTO_EQUIP_SOURCE_OTHER,
    CONFIG_BOOL_AUTO_EQUIP_SUPPLY_AMMO,
    CONFIG_BOOL_AUTO_EQUIP_MAIL_REPLACED_ITEMS,
    CONFIG_BOOL_AUTO_EQUIP_MARK_GENERATED_ITEMS,
    CONFIG_BOOL_AUTO_ENCHANT_ON_LEVEL_UP,
    CONFIG_BOOL_AUTO_ENCHANT_ON_TALENT_LEARN,
    CONFIG_BOOL_AUTO_ENCHANT_ON_LOGIN,
    CONFIG_BOOL_AUTO_ENCHANT_ON_TALENT_RESET,
    CONFIG_BOOL_AUTO_ENCHANT_REPLACE_EXISTING,
    CONFIG_BOOL_AUTO_ENCHANT_SOURCE_ENCHANTING,
    CONFIG_BOOL_AUTO_ENCHANT_SOURCE_SCOPES,
    CONFIG_BOOL_AUTO_ENCHANT_SOURCE_SHIELD_SPIKES,
    CONFIG_BOOL_AUTO_ENCHANT_SOURCE_ARMOR_KITS,
    CONFIG_BOOL_AUTO_ENCHANT_SOURCE_LIBRAMS,
    CONFIG_BOOL_AUTO_ENCHANT_SOURCE_ZANDALAR,
    CONFIG_BOOL_AUTO_ENCHANT_SOURCE_ARGENT_DAWN,
    CONFIG_BOOL_AUTO_ENCHANT_SOURCE_NAXXRAMAS,
    CONFIG_BOOL_ARENA_ENABLED,
    CONFIG_BOOL_ARENA_ALLOW_ITEM_SWAP,
    CONFIG_BOOL_ARENA_ALLOW_TRINKET_SWAP,
    CONFIG_BOOL_ARENA_ANNOUNCE_QUEUE,
    CONFIG_BOOL_ARENA_1V1_BLOCK_HEALER_SPECS,
    CONFIG_BOOL_ARENA_LEAVE_QUEUES_ON_LOGOUT,
    CONFIG_BOOL_ARENA_RANDOM_WEATHER,
    CONFIG_BOOL_ARENA_SPECTATE,
    CONFIG_BOOL_ARENA_SPECTATOR_NO_EXTRAPOLATION,
    CONFIG_BOOL_ARENA_RESET_ALL_COOLDOWNS,
    CONFIG_BOOL_ARENA_FRAME_DIMINISHING,
    CONFIG_BOOL_ARENA_ABSORB_COUNTS_AS_HEALING,
    CONFIG_BOOL_ARENA_NAGRAND_TORNADO,
