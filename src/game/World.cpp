...
void World::LoadConfigSettings(bool reload)
{
    ...
    setConfig(CONFIG_BOOL_AUTO_LEARN_ON_LEVEL_UP, "PlayerAutoProgression.AutoLearn.OnLevelUp", true);
    setConfig(CONFIG_BOOL_AUTO_LEARN_ON_TALENT_LEARN, "PlayerAutoProgression.AutoLearn.OnTalentLearn", true);
    setConfig(CONFIG_BOOL_AUTO_LEARN_ON_LOGIN, "PlayerAutoProgression.AutoLearn.OnLogin", false);
    ...
    setConfig(CONFIG_BOOL_AUTO_EQUIP_ON_TALENT_RESET, "PlayerAutoProgression.AutoEquip.OnTalentReset", false);
    setConfig(CONFIG_BOOL_AUTO_EQUIP_REQUIRE_DISCOVERED, "PlayerAutoProgression.AutoEquip.RequireDiscovered", false);
    setConfig(CONFIG_BOOL_AUTO_EQUIP_IGNORE_ITEMS_WITHOUT_STATS_AND_ARMOR, "PlayerAutoProgression.AutoEquip.IgnoreItemsWithoutStatsAndArmor", false);
    setConfig(CONFIG_BOOL_AUTO_EQUIP_REPLACE_EXISTING, "PlayerAutoProgression.AutoEquip.ReplaceExisting", true);
    setConfig(CONFIG_BOOL_AUTO_EQUIP_DELETE_REPLACED_ITEMS, "PlayerAutoProgression.AutoEquip.DeleteReplacedItems", true);
    setConfig(CONFIG_BOOL_AUTO_EQUIP_INCLUDE_QUEST_REWARDS, "PlayerAutoProgression.AutoEquip.IncludeQuestRewards", false);
    setConfig(CONFIG_BOOL_AUTO_EQUIP_ALLOW_BOE_QUEST_REWARDS_WITHOUT_QUEST, "PlayerAutoProgression.AutoEquip.AllowBoEQuestRewardsWithoutQuest", true);
    setConfig(CONFIG_BOOL_AUTO_EQUIP_SOURCE_VENDOR, "PlayerAutoProgression.AutoEquip.Source.Vendor", true);
    setConfig(CONFIG_BOOL_AUTO_EQUIP_SOURCE_CRAFTED, "PlayerAutoProgression.AutoEquip.Source.Crafted", true);
    setConfig(CONFIG_BOOL_AUTO_EQUIP_SOURCE_WORLD_LOOT, "PlayerAutoProgression.AutoEquip.Source.WorldLoot", true);
    ...
    setConfig(CONFIG_BOOL_AUTO_ENCHANT_ON_TALENT_RESET, "PlayerAutoProgression.AutoEnchant.OnTalentReset", false);
    ...
    setConfigMin(CONFIG_FLOAT_AUTO_EQUIP_MIN_UPGRADE_PERCENT, "PlayerAutoProgression.AutoEquip.MinimumUpgradePercent", 5.0f, 0.0f);
    setConfigMin(CONFIG_FLOAT_AUTO_EQUIP_ARMOR_CLASS_BONUS_PERCENT, "PlayerAutoProgression.AutoEquip.HighestArmorClassBonusPercent", 10.0f, 0.0f);
    setConfigMin(CONFIG_FLOAT_AUTO_EQUIP_SET_BONUS_SCALE, "PlayerAutoProgression.AutoEquip.Weight.SetBonus", 1.0f, 0.0f);
    ...
    // the arena spectator's relay cadence - see the instance branch at the tail of Map::Update
    setConfigMinMax(CONFIG_UINT32_MAPUPDATE_INSTANCED_SUBTICK, "MapUpdate.Instanced.SubTick", 0, 0, 100);
    ...
    setConfig(CONFIG_BOOL_ARENA_FRAME_DIMINISHING, "Arena.FrameDiminishing", true);
    ...
    setConfigMinMax(CONFIG_UINT32_ARENA_NAGRAND_TORNADO_DAMAGE_PCT, "Arena.NagrandTornado.DamagePercent", 5, 0, 50);
